...
---
## 1. SQL Injection이란?
**SQL Injection(SQLi)**은 웹 애플리케이션이 사용자의 입력값을 검증하지 않고 SQL 쿼리에 포함시킬 때 발생하는 보안 취약점입니다. 공격자는 입력값에 악의적인 SQL 코드를 삽입해 데이터베이스에서 무단으로 데이터를 조회, 수정, 삭제하거나 인증을 우회할 수 있습니다.(../assets/img/blog/SQLinjection.png)
